...
class AsignacionCuerpoMaterialMayor(EventoHojaVidaMaterialMayor):
    ...
    fecha_de_asignacion = models.DateField(verbose_name='Fecha de asignación')
    acta_de_entrega_de_asignacion = models.FileField(upload_to=lambda i, fn:  generate_uploaded_hoja_de_vida_file_name('acta_de_entrega_de_asignacion', i, fn), verbose_name=u'Acta de entrega de asignación')
    listado_de_material_menor = models.FileField(upload_to=lambda i, fn:  generate_uploaded_hoja_de_vida_file_name('listado_de_material_menor', i, fn), verbose_name=u'Listado de material menor')
