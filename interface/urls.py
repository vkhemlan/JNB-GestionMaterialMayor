...
urlpatterns += patterns('interface.views_media',
    ...
    (r'media/documentos/material_mayor/(?P<material_mayor>\d+)/mantenciones_programadas/(?P<archivo_id>\d+)\.(?P<extension>\w+)$','descargar_documento_mantencion_programada_material_mayor'),
)
