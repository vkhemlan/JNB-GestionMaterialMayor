...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.validado_por_operaciones'
        db.add_column('interface_materialmayor', 'validado_por_operaciones', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaterialMayor.validado_por_operaciones'
        db.delete_column('interface_materialmayor', 'validado_por_operaciones')
