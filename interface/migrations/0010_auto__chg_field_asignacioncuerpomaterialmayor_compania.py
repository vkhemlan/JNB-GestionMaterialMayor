...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AsignacionCuerpoMaterialMayor.compania'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'compania_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Compania'], null=True))


    def backwards(self, orm):
        
        # Changing field 'AsignacionCuerpoMaterialMayor.compania'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'compania_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['interface.Compania']))
