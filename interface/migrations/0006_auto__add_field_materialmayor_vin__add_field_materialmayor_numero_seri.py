...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.vin'
        db.add_column('interface_materialmayor', 'vin', self.gf('django.db.models.fields.CharField')(default='9999', max_length=255), keep_default=False)

        # Adding field 'MaterialMayor.numero_serie'
        db.add_column('interface_materialmayor', 'numero_serie', self.gf('django.db.models.fields.CharField')(default='9999', max_length=255), keep_default=False)

        # Adding field 'MaterialMayor.peso_bruto_vehicular'
        db.add_column('interface_materialmayor', 'peso_bruto_vehicular', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaterialMayor.vin'
        db.delete_column('interface_materialmayor', 'vin')

        # Deleting field 'MaterialMayor.numero_serie'
        db.delete_column('interface_materialmayor', 'numero_serie')

        # Deleting field 'MaterialMayor.peso_bruto_vehicular'
        db.delete_column('interface_materialmayor', 'peso_bruto_vehicular')
