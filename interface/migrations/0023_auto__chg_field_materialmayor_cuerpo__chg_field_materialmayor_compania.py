...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MaterialMayor.cuerpo'
        db.alter_column('interface_materialmayor', 'cuerpo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Cuerpo'], null=True))

        # Changing field 'MaterialMayor.compania'
        db.alter_column('interface_materialmayor', 'compania_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Compania'], null=True))


    def backwards(self, orm):
        
        # Changing field 'MaterialMayor.cuerpo'
        db.alter_column('interface_materialmayor', 'cuerpo_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.Cuerpo']))

        # Changing field 'MaterialMayor.compania'
        db.alter_column('interface_materialmayor', 'compania_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.Compania']))
