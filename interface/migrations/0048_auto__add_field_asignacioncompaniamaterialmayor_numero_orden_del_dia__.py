...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsignacionCompaniaMaterialMayor.numero_orden_del_dia'
        db.add_column('interface_asignacioncompaniamaterialmayor', 'numero_orden_del_dia', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'AsignacionCompaniaMaterialMayor.fecha_orden_del_dia'
        db.add_column('interface_asignacioncompaniamaterialmayor', 'fecha_orden_del_dia', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 17)), keep_default=False)

        # Adding field 'AsignacionCompaniaMaterialMayor.orden_del_dia'
        db.add_column('interface_asignacioncompaniamaterialmayor', 'orden_del_dia', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AsignacionCompaniaMaterialMayor.numero_orden_del_dia'
        db.delete_column('interface_asignacioncompaniamaterialmayor', 'numero_orden_del_dia')

        # Deleting field 'AsignacionCompaniaMaterialMayor.fecha_orden_del_dia'
        db.delete_column('interface_asignacioncompaniamaterialmayor', 'fecha_orden_del_dia')

        # Deleting field 'AsignacionCompaniaMaterialMayor.orden_del_dia'
        db.delete_column('interface_asignacioncompaniamaterialmayor', 'orden_del_dia')
