...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsignacionCuerpoMaterialMayor.escritura_publica'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'escritura_publica', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AsignacionCuerpoMaterialMayor.escritura_publica'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'escritura_publica')
