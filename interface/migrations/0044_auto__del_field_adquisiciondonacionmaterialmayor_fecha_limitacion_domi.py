...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdquisicionDonacionMaterialMayor.fecha_vencimiento_limitacion_dominio'
        db.add_column('interface_adquisiciondonacionmaterialmayor', 'fecha_vencimiento_limitacion_dominio', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AdquisicionDonacionMaterialMayor.fecha_vencimiento_limitacion_dominio'
        db.delete_column('interface_adquisiciondonacionmaterialmayor', 'fecha_vencimiento_limitacion_dominio')
