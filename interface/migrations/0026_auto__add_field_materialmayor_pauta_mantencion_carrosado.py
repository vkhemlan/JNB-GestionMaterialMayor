...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.pauta_mantencion_carrosado'
        db.add_column('interface_materialmayor', 'pauta_mantencion_carrosado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.PautaMantencionCarrosado'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaterialMayor.pauta_mantencion_carrosado'
        db.delete_column('interface_materialmayor', 'pauta_mantencion_carrosado_id')
    ...
    models = {
        ...
        'interface.operacionmantencion': {
            'Meta': {'ordering': "['descripcion']", 'object_name': 'OperacionMantencion'},
