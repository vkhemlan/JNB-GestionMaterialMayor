...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventoHojaVidaMaterialMayor.rol_usuario'
        db.add_column('interface_eventohojavidamaterialmayor', 'rol_usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Rol'], null=True, blank=True), keep_default=False)

        # Adding field 'EventoHojaVidaMaterialMayor.cuerpo_usuario'
        db.add_column('interface_eventohojavidamaterialmayor', 'cuerpo_usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Cuerpo'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EventoHojaVidaMaterialMayor.rol_usuario'
        db.delete_column('interface_eventohojavidamaterialmayor', 'rol_usuario_id')

        # Deleting field 'EventoHojaVidaMaterialMayor.cuerpo_usuario'
        db.delete_column('interface_eventohojavidamaterialmayor', 'cuerpo_usuario_id')
