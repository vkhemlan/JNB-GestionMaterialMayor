...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.tipo_caja_cambio'
        db.add_column('interface_materialmayor', 'tipo_caja_cambio', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.TipoCajaCambioMaterialMayor']), keep_default=False)

        # Adding field 'MaterialMayor.tipo_combustible'
        db.add_column('interface_materialmayor', 'tipo_combustible', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.TipoCombustibleMaterialMayor']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MaterialMayor.tipo_caja_cambio'
        db.delete_column('interface_materialmayor', 'tipo_caja_cambio_id')

        # Deleting field 'MaterialMayor.tipo_combustible'
        db.delete_column('interface_materialmayor', 'tipo_combustible_id')
