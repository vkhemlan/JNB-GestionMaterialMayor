...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.marca_carrosado'
        db.add_column('interface_materialmayor', 'marca_carrosado', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['interface.MarcaCarrosadoMaterialMayor']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('interface_materialmayor', 'modelo_carrosado', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['interface.ModeloCarrosadoMaterialMayor']), keep_default=False)

        # Deleting field 'MaterialMayor.marca_carrosado'
        db.delete_column('interface_materialmayor', 'marca_carrosado_id')
