...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'CambioPautaMantencionCarrosadoMaterialMayor.nueva_pauta_mantencion_carrosado' to match new field type.
        db.rename_column('interface_cambiopautamantencioncarrosadomaterialmayor', 'nueva_pauta_mantencion_carrosado_id', 'nueva_pauta_mantencion_carrosado')
        # Changing field 'CambioPautaMantencionCarrosadoMaterialMayor.nueva_pauta_mantencion_carrosado'
        db.alter_column('interface_cambiopautamantencioncarrosadomaterialmayor', 'nueva_pauta_mantencion_carrosado', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Removing index on 'CambioPautaMantencionCarrosadoMaterialMayor', fields ['nueva_pauta_mantencion_carrosado']
        db.delete_index('interface_cambiopautamantencioncarrosadomaterialmayor', ['nueva_pauta_mantencion_carrosado_id'])


    def backwards(self, orm):
        
        # Adding index on 'CambioPautaMantencionCarrosadoMaterialMayor', fields ['nueva_pauta_mantencion_carrosado']
        db.create_index('interface_cambiopautamantencioncarrosadomaterialmayor', ['nueva_pauta_mantencion_carrosado_id'])

        # Renaming column for 'CambioPautaMantencionCarrosadoMaterialMayor.nueva_pauta_mantencion_carrosado' to match new field type.
        db.rename_column('interface_cambiopautamantencioncarrosadomaterialmayor', 'nueva_pauta_mantencion_carrosado', 'nueva_pauta_mantencion_carrosado_id')
        # Changing field 'CambioPautaMantencionCarrosadoMaterialMayor.nueva_pauta_mantencion_carrosado'
        db.alter_column('interface_cambiopautamantencioncarrosadomaterialmayor', 'nueva_pauta_mantencion_carrosado_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.PautaMantencionCarrosado']))
