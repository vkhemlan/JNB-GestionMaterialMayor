...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CambioDenominacion'
        db.create_table('interface_cambiodenominacion', (
            ...
            ('nueva_denominacion', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('interface', ['CambioDenominacion'])

        # Adding field 'MaterialMayor.denominacion'
        db.add_column('interface_materialmayor', 'denominacion', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CambioDenominacion'
        db.delete_table('interface_cambiodenominacion')

        # Deleting field 'MaterialMayor.denominacion'
        db.delete_column('interface_materialmayor', 'denominacion')
