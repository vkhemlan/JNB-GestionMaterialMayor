...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdquisicionCompraMaterialMayor.numero_orden_de_compra'
        db.add_column('interface_adquisicioncompramaterialmayor', 'numero_orden_de_compra', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdquisicionCompraMaterialMayor.numero_orden_de_compra'
        db.delete_column('interface_adquisicioncompramaterialmayor', 'numero_orden_de_compra')
