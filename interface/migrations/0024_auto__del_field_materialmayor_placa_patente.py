...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MaterialMayor.placa_patente'
        db.delete_column('interface_materialmayor', 'placa_patente')


    def backwards(self, orm):
        
        # Adding field 'MaterialMayor.placa_patente'
        db.add_column('interface_materialmayor', 'placa_patente', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
