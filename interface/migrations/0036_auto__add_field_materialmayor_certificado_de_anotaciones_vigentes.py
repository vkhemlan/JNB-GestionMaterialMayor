...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.certificado_de_anotaciones_vigentes'
        db.add_column('interface_materialmayor', 'certificado_de_anotaciones_vigentes', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaterialMayor.certificado_de_anotaciones_vigentes'
        db.delete_column('interface_materialmayor', 'certificado_de_anotaciones_vigentes')
