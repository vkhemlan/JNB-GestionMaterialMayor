...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Region.webservice_id'
        db.add_column('interface_region', 'webservice_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Region.webservice_id'
        db.delete_column('interface_region', 'webservice_id')
