...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.rol'
        db.alter_column('interface_userprofile', 'rol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Rol'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.rol'
        db.alter_column('interface_userprofile', 'rol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Rol']))
