...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CambioVinMaterialMayor'
        db.create_table('interface_cambiovinmaterialmayor', (
            ...
            ('nuevo_vin', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('interface', ['CambioVinMaterialMayor'])


    def backwards(self, orm):
        
        # Deleting model 'CambioVinMaterialMayor'
        db.delete_table('interface_cambiovinmaterialmayor')
