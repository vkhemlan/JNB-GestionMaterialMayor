...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OperacionMantencion.descripcion'
        db.alter_column('interface_operacionmantencion', 'descripcion', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'OperacionMantencion.descripcion'
        db.alter_column('interface_operacionmantencion', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=255))
