...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('interface_adquisicioncompramaterialmayor', 'numero_orden_de_compra', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'AdquisicionCompraMaterialMayor.numero_declaracion_de_ingreso'
        db.alter_column('interface_adquisicioncompramaterialmayor', 'numero_declaracion_de_ingreso', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
