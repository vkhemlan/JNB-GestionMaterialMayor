...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.cuerpo'
        db.add_column('interface_materialmayor', 'cuerpo', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.Cuerpo']), keep_default=False)

        # Adding field 'MaterialMayor.compania'
        db.add_column('interface_materialmayor', 'compania', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.Compania']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaterialMayor.cuerpo'
        db.delete_column('interface_materialmayor', 'cuerpo_id')

        # Deleting field 'MaterialMayor.compania'
        db.delete_column('interface_materialmayor', 'compania_id')
