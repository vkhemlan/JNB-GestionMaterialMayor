...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MaterialMayor.adquisicion'
        db.alter_column('interface_materialmayor', 'adquisicion_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['interface.AdquisicionMaterialMayor'], unique=True))

        # Adding unique constraint on 'MaterialMayor', fields ['adquisicion']
        db.create_unique('interface_materialmayor', ['adquisicion_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MaterialMayor', fields ['adquisicion']
        db.delete_unique('interface_materialmayor', ['adquisicion_id'])

        # Changing field 'MaterialMayor.adquisicion'
        db.alter_column('interface_materialmayor', 'adquisicion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.AdquisicionMaterialMayor']))
