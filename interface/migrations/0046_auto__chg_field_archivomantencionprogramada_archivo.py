...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArchivoMantencionProgramada.archivo'
        db.alter_column('interface_archivomantencionprogramada', 'archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'ArchivoMantencionProgramada.archivo'
        db.alter_column('interface_archivomantencionprogramada', 'archivo', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))
    ...
    models = {
        ...
        'interface.archivomantencionprogramada': {
            ...
            'archivo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
