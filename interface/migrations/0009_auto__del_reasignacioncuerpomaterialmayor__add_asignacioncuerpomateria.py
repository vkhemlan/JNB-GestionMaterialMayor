...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ReasignacionCuerpoMaterialMayor'
        db.delete_table('interface_reasignacioncuerpomaterialmayor')
        ...
        # Changing field 'AdquisicionDonacionMaterialMayor.donante'
        db.alter_column('interface_adquisiciondonacionmaterialmayor', 'donante', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Adding model 'ReasignacionCuerpoMaterialMayor'
        db.create_table('interface_reasignacioncuerpomaterialmayor', (
            ('cuerpo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Cuerpo'])),
            ('eventohojavidamaterialmayor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['interface.EventoHojaVidaMaterialMayor'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('interface', ['ReasignacionCuerpoMaterialMayor'])

        # Deleting model 'AsignacionCuerpoMaterialMayor'
        db.delete_table('interface_asignacioncuerpomaterialmayor')

        # Changing field 'AdquisicionDonacionMaterialMayor.donante'
        db.alter_column('interface_adquisiciondonacionmaterialmayor', 'donante', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
