...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdquisicionDonacionMaterialMayor.forma_adquisicion'
        db.add_column('interface_adquisiciondonacionmaterialmayor', 'forma_adquisicion', self.gf('django.db.models.fields.CharField')(default='Donacion', max_length=255), keep_default=False)

        # Adding field 'AdquisicionDonacionMaterialMayor.fecha_limitacion_dominio'
        db.add_column('interface_adquisiciondonacionmaterialmayor', 'fecha_limitacion_dominio', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'AdquisicionDonacionMaterialMayor.dueno_comodato'
        db.add_column('interface_adquisiciondonacionmaterialmayor', 'dueno_comodato', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdquisicionDonacionMaterialMayor.forma_adquisicion'
        db.delete_column('interface_adquisiciondonacionmaterialmayor', 'forma_adquisicion')

        # Deleting field 'AdquisicionDonacionMaterialMayor.fecha_limitacion_dominio'
        db.delete_column('interface_adquisiciondonacionmaterialmayor', 'fecha_limitacion_dominio')

        # Deleting field 'AdquisicionDonacionMaterialMayor.dueno_comodato'
        db.delete_column('interface_adquisiciondonacionmaterialmayor', 'dueno_comodato')
    ...
    models = {
        ...
        'interface.cambiopautamantencioncarrosadomaterialmayor': {
            ...
            'eventohojavidamaterialmayor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.EventoHojaVidaMaterialMayor']", 'unique': 'True', 'primary_key': 'True'}),
            'nueva_pauta_mantencion_carrosado': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['interface.PautaMantencionCarrosado']"})
        },
        'interface.cargo': {
