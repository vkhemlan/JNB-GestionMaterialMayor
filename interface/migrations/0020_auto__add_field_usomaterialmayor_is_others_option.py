...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UsoMaterialMayor.is_others_option'
        db.add_column('interface_usomaterialmayor', 'is_others_option', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UsoMaterialMayor.is_others_option'
        db.delete_column('interface_usomaterialmayor', 'is_others_option')
