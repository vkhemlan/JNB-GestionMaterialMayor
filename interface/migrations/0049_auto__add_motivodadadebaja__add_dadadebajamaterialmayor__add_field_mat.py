...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.dada_de_baja'
        db.add_column('interface_materialmayor', 'dada_de_baja', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.DadaDeBajaMaterialMayor'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MaterialMayor.dada_de_baja'
        db.delete_column('interface_materialmayor', 'dada_de_baja_id')
    ...
    models = {
        ...
        'interface.materialmayor': {
            ...
            'dada_de_baja': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['interface.DadaDeBajaMaterialMayor']", 'null': 'True', 'blank': 'True'}),
