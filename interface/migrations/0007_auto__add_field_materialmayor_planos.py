...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.planos'
        db.add_column('interface_materialmayor', 'planos', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaterialMayor.planos'
        db.delete_column('interface_materialmayor', 'planos')
    ...
    models = {
        ...
        'interface.materialmayor': {
            ...
            'planos': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
