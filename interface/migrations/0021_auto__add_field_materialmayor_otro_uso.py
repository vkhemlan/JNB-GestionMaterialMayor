...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.otro_uso'
        db.add_column('interface_materialmayor', 'otro_uso', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MaterialMayor.otro_uso'
        db.delete_column('interface_materialmayor', 'otro_uso')
