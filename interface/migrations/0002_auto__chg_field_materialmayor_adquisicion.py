...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('interface_materialmayor', 'adquisicion_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['interface.AdquisicionMaterialMayor'], unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'MaterialMayor.adquisicion'
        db.alter_column('interface_materialmayor', 'adquisicion_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['interface.AdquisicionMaterialMayor'], unique=True))
