...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'MaterialMayor.certificado_de_anotaciones_vigentes' to match new field type.
        db.rename_column('interface_materialmayor', 'certificado_de_anotaciones_vigentes', 'certificado_de_anotaciones_vigentes_id')
        # Changing field 'MaterialMayor.certificado_de_anotaciones_vigentes'
        db.alter_column('interface_materialmayor', 'certificado_de_anotaciones_vigentes_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.CambioCertificadoAnotacionesVigentes'], null=True))

        # Adding index on 'MaterialMayor', fields ['certificado_de_anotaciones_vigentes']
        db.create_index('interface_materialmayor', ['certificado_de_anotaciones_vigentes_id'])


    def backwards(self, orm):
        
        # Removing index on 'MaterialMayor', fields ['certificado_de_anotaciones_vigentes']
        db.delete_index('interface_materialmayor', ['certificado_de_anotaciones_vigentes_id'])

        # Renaming column for 'MaterialMayor.certificado_de_anotaciones_vigentes' to match new field type.
        db.rename_column('interface_materialmayor', 'certificado_de_anotaciones_vigentes_id', 'certificado_de_anotaciones_vigentes')
        # Changing field 'MaterialMayor.certificado_de_anotaciones_vigentes'
        db.alter_column('interface_materialmayor', 'certificado_de_anotaciones_vigentes', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
