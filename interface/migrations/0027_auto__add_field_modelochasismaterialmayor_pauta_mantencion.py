...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ModeloChasisMaterialMayor.pauta_mantencion'
        db.add_column('interface_modelochasismaterialmayor', 'pauta_mantencion', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.PautaMantencionChasis']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ModeloChasisMaterialMayor.pauta_mantencion'
        db.delete_column('interface_modelochasismaterialmayor', 'pauta_mantencion_id')
