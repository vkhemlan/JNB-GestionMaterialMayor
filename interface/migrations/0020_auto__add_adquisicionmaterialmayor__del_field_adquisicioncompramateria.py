...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AdquisicionCompraMaterialMayor.materialmayor_ptr'
        db.delete_column('interface_adquisicioncompramaterialmayor', 'materialmayor_ptr_id')

        # Adding field 'AdquisicionCompraMaterialMayor.adquisicionmaterialmayor_ptr'
        db.add_column('interface_adquisicioncompramaterialmayor', 'adquisicionmaterialmayor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['interface.AdquisicionMaterialMayor'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'AdquisicionDonacionMaterialMayor.materialmayor_ptr'
        db.delete_column('interface_adquisiciondonacionmaterialmayor', 'materialmayor_ptr_id')

        # Adding field 'AdquisicionDonacionMaterialMayor.adquisicionmaterialmayor_ptr'
        db.add_column('interface_adquisiciondonacionmaterialmayor', 'adquisicionmaterialmayor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['interface.AdquisicionMaterialMayor'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'MaterialMayor.modo_adquisicion'
        db.delete_column('interface_materialmayor', 'modo_adquisicion_id')

        # Adding field 'MaterialMayor.adquisicion'
        db.add_column('interface_materialmayor', 'adquisicion', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.AdquisicionMaterialMayor']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AdquisicionCompraMaterialMayor.materialmayor_ptr'
        db.add_column('interface_adquisicioncompramaterialmayor', 'materialmayor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['interface.MaterialMayor'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'AdquisicionCompraMaterialMayor.adquisicionmaterialmayor_ptr'
        db.delete_column('interface_adquisicioncompramaterialmayor', 'adquisicionmaterialmayor_ptr_id')

        # Adding field 'AdquisicionDonacionMaterialMayor.materialmayor_ptr'
        db.add_column('interface_adquisiciondonacionmaterialmayor', 'materialmayor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['interface.MaterialMayor'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'AdquisicionDonacionMaterialMayor.adquisicionmaterialmayor_ptr'
        db.delete_column('interface_adquisiciondonacionmaterialmayor', 'adquisicionmaterialmayor_ptr_id')

        # Adding field 'MaterialMayor.modo_adquisicion'
        db.add_column('interface_materialmayor', 'modo_adquisicion', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.ModoAdquisicionMaterialMayor']), keep_default=False)

        # Deleting field 'MaterialMayor.adquisicion'
        db.delete_column('interface_materialmayor', 'adquisicion_id')
    ...
    models = {
        ...
        'interface.materialmayor': {
            ...
            'adquisicion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['interface.AdquisicionMaterialMayor']"}),
