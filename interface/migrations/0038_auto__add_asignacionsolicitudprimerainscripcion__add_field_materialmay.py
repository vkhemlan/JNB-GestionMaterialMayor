...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MaterialMayor.asignacion_solicitud_primera_inscripcion'
        db.add_column('interface_materialmayor', 'asignacion_solicitud_primera_inscripcion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.AsignacionSolicitudPrimeraInscripcion'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MaterialMayor.asignacion_solicitud_primera_inscripcion'
        db.delete_column('interface_materialmayor', 'asignacion_solicitud_primera_inscripcion_id')
