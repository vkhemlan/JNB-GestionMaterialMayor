...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'OperacionMantencion'
        db.delete_table('interface_operacionmantencion')

        # Deleting field 'OperacionMantencionPauta.operacionmantencion_ptr'
        db.delete_column('interface_operacionmantencionpauta', 'operacionmantencion_ptr_id')

        # Adding field 'OperacionMantencionPauta.id'
        db.add_column('interface_operacionmantencionpauta', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)

        # Adding field 'OperacionMantencionPauta.descripcion'
        db.add_column('interface_operacionmantencionpauta', 'descripcion', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'OperacionMantencionPauta.frecuencia'
        db.add_column('interface_operacionmantencionpauta', 'frecuencia', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['interface.FrecuenciaOperacion']), keep_default=False)

        # Deleting field 'OperacionMantencionProgramada.operacionmantencion_ptr'
        db.delete_column('interface_operacionmantencionprogramada', 'operacionmantencion_ptr_id')

        # Adding field 'OperacionMantencionProgramada.id'
        db.add_column('interface_operacionmantencionprogramada', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)

        # Adding field 'OperacionMantencionProgramada.descripcion'
        db.add_column('interface_operacionmantencionprogramada', 'descripcion', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'OperacionMantencionProgramada.id_operacion_mantencion_pauta'
        db.add_column('interface_operacionmantencionprogramada', 'id_operacion_mantencion_pauta', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'OperacionMantencion'
        db.create_table('interface_operacionmantencion', (
            ('descripcion', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('frecuencia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.FrecuenciaOperacion'])),
        ))
        db.send_create_signal('interface', ['OperacionMantencion'])

        # Adding field 'OperacionMantencionPauta.operacionmantencion_ptr'
        db.add_column('interface_operacionmantencionpauta', 'operacionmantencion_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['interface.OperacionMantencion'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'OperacionMantencionPauta.id'
        db.delete_column('interface_operacionmantencionpauta', 'id')

        # Deleting field 'OperacionMantencionPauta.descripcion'
        db.delete_column('interface_operacionmantencionpauta', 'descripcion')

        # Deleting field 'OperacionMantencionPauta.frecuencia'
        db.delete_column('interface_operacionmantencionpauta', 'frecuencia_id')

        # Adding field 'OperacionMantencionProgramada.operacionmantencion_ptr'
        db.add_column('interface_operacionmantencionprogramada', 'operacionmantencion_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['interface.OperacionMantencion'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'OperacionMantencionProgramada.id'
        db.delete_column('interface_operacionmantencionprogramada', 'id')

        # Deleting field 'OperacionMantencionProgramada.descripcion'
        db.delete_column('interface_operacionmantencionprogramada', 'descripcion')

        # Deleting field 'OperacionMantencionProgramada.id_operacion_mantencion_pauta'
        db.delete_column('interface_operacionmantencionprogramada', 'id_operacion_mantencion_pauta')
