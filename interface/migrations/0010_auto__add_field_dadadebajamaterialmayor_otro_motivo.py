...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DadaDeBajaMaterialMayor.otro_motivo'
        db.add_column('interface_dadadebajamaterialmayor', 'otro_motivo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DadaDeBajaMaterialMayor.otro_motivo'
        db.delete_column('interface_dadadebajamaterialmayor', 'otro_motivo')
    ...
    models = {
        ...
        'interface.dadadebajamaterialmayor': {
            ...
            'numero_orden_del_dia': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'observaciones': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'otro_motivo': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
