...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsignacionCuerpoMaterialMayor.fecha_de_transferencia'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_transferencia', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'AsignacionCuerpoMaterialMayor.notaria'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'notaria', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'AsignacionCuerpoMaterialMayor.numero_de_repertorio'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'numero_de_repertorio', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'AsignacionCuerpoMaterialMayor.acta_de_entrega_de_asignacion'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'acta_de_entrega_de_asignacion', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'AsignacionCuerpoMaterialMayor.listado_de_material_menor'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'listado_de_material_menor', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Adding field 'MaterialMayor.uso'
        db.add_column('interface_materialmayor', 'uso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.UsoMaterialMayor'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AsignacionCuerpoMaterialMayor.fecha_de_transferencia'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_transferencia')

        # Deleting field 'AsignacionCuerpoMaterialMayor.notaria'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'notaria')

        # Deleting field 'AsignacionCuerpoMaterialMayor.numero_de_repertorio'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'numero_de_repertorio')

        # Changing field 'AsignacionCuerpoMaterialMayor.acta_de_entrega_de_asignacion'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'acta_de_entrega_de_asignacion', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))

        # Changing field 'AsignacionCuerpoMaterialMayor.listado_de_material_menor'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'listado_de_material_menor', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))

        # Deleting field 'MaterialMayor.uso'
        db.delete_column('interface_materialmayor', 'uso_id')
    ...
    models = {
        ...
        'interface.asignacioncuerpomaterialmayor': {
            ...
            'acta_de_entrega_de_asignacion': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'fecha_de_transferencia': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'listado_de_material_menor': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
