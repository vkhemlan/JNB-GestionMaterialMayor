...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.cuerpo'
        db.add_column('interface_userprofile', 'cuerpo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interface.Cuerpo'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.cuerpo'
        db.delete_column('interface_userprofile', 'cuerpo_id')
