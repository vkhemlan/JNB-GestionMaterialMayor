...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CambioPesoBrutoVehicularMaterialMayor'
        db.create_table('interface_cambiopesobrutovehicularmaterialmayor', (
            ...
            ('nuevo_peso_bruto_vehicular', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('interface', ['CambioPesoBrutoVehicularMaterialMayor'])


    def backwards(self, orm):
        
        # Deleting model 'CambioPesoBrutoVehicularMaterialMayor'
        db.delete_table('interface_cambiopesobrutovehicularmaterialmayor')
    ...
    models = {
        ...
        'interface.adquisicioncompramaterialmayor': {
            ...
            'numero_declaracion_de_ingreso': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'numero_orden_de_compra': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'interface.cambiodenominacion': {
            'Meta': {'ordering': "['material_mayor', 'fecha']", 'object_name': 'CambioDenominacion', '_ormbases': ['interface.EventoHojaVidaMaterialMayor']},
            'eventohojavidamaterialmayor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.EventoHojaVidaMaterialMayor']", 'unique': 'True', 'primary_key': 'True'}),
            'nueva_denominacion': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'interface.cambionumeroseriematerialmayor': {
            'Meta': {'ordering': "['material_mayor', 'fecha']", 'object_name': 'CambioNumeroSerieMaterialMayor', '_ormbases': ['interface.EventoHojaVidaMaterialMayor']},
            'eventohojavidamaterialmayor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.EventoHojaVidaMaterialMayor']", 'unique': 'True', 'primary_key': 'True'}),
            'nuevo_numero_serie': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'interface.cambiopesobrutovehicularmaterialmayor': {
            'Meta': {'ordering': "['material_mayor', 'fecha']", 'object_name': 'CambioPesoBrutoVehicularMaterialMayor', '_ormbases': ['interface.EventoHojaVidaMaterialMayor']},
            'eventohojavidamaterialmayor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.EventoHojaVidaMaterialMayor']", 'unique': 'True', 'primary_key': 'True'}),
            'nuevo_peso_bruto_vehicular': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'interface.cambiovinmaterialmayor': {
            'Meta': {'ordering': "['material_mayor', 'fecha']", 'object_name': 'CambioVinMaterialMayor', '_ormbases': ['interface.EventoHojaVidaMaterialMayor']},
            'eventohojavidamaterialmayor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.EventoHojaVidaMaterialMayor']", 'unique': 'True', 'primary_key': 'True'}),
            'nuevo_vin': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'interface.cargo': {
        ...
        'interface.dadadebajamaterialmayor': {
            ...
            'archivo_orden_del_dia': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'eventohojavidamaterialmayor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.EventoHojaVidaMaterialMayor']", 'unique': 'True', 'primary_key': 'True'}),
            'fecha_dada_de_baja': ('django.db.models.fields.DateField', [], {}),
            'fecha_orden_del_dia': ('django.db.models.fields.DateField', [], {}),
        ...
        'interface.eventohojavidamaterialmayor': {
            ...
            'cargos_usuario': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['interface.Cargo']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
        ...
        'interface.materialmayor': {
            ...
            'adquisicion': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.AdquisicionMaterialMayor']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'numero_serie': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'peso_bruto_vehicular': ('django.db.models.fields.PositiveIntegerField', [], {}),
            ...
            'vin': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'interface.userprofile': {
            ...
            'cargos': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['interface.Cargo']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
            'cuerpo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['interface.Cuerpo']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
