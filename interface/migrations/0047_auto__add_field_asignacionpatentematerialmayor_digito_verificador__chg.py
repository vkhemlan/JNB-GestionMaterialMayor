...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsignacionPatenteMaterialMayor.digito_verificador'
        db.add_column('interface_asignacionpatentematerialmayor', 'digito_verificador', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Changing field 'AsignacionPatenteMaterialMayor.patente'
        db.alter_column('interface_asignacionpatentematerialmayor', 'patente', self.gf('django.db.models.fields.CharField')(max_length=6))


    def backwards(self, orm):
        
        # Deleting field 'AsignacionPatenteMaterialMayor.digito_verificador'
        db.delete_column('interface_asignacionpatentematerialmayor', 'digito_verificador')

        # Changing field 'AsignacionPatenteMaterialMayor.patente'
        db.alter_column('interface_asignacionpatentematerialmayor', 'patente', self.gf('django.db.models.fields.CharField')(max_length=255))
