...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CambioNumeroSerieMaterialMayor'
        db.create_table('interface_cambionumeroseriematerialmayor', (
            ...
            ('nuevo_numero_serie', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('interface', ['CambioNumeroSerieMaterialMayor'])


    def backwards(self, orm):
        
        # Deleting model 'CambioNumeroSerieMaterialMayor'
        db.delete_table('interface_cambionumeroseriematerialmayor')
