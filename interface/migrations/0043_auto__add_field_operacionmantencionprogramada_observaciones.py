...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OperacionMantencionProgramada.observaciones'
        db.add_column('interface_operacionmantencionprogramada', 'observaciones', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OperacionMantencionProgramada.observaciones'
        db.delete_column('interface_operacionmantencionprogramada', 'observaciones')
