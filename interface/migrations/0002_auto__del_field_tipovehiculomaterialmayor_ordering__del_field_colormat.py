...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TipoVehiculoMaterialMayor.ordering'
        db.delete_column('interface_tipovehiculomaterialmayor', 'ordering')

        # Deleting field 'ColorMaterialMayor.ordering'
        db.delete_column('interface_colormaterialmayor', 'ordering')


    def backwards(self, orm):
        
        # Adding field 'TipoVehiculoMaterialMayor.ordering'
        db.add_column('interface_tipovehiculomaterialmayor', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ColorMaterialMayor.ordering'
        db.add_column('interface_colormaterialmayor', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
