...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsignacionCuerpoMaterialMayor.fecha_de_asignacion'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_asignacion', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 9, 28)), keep_default=False)

        # Adding field 'AsignacionCuerpoMaterialMayor.acta_de_entrega_de_asignacion'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'acta_de_entrega_de_asignacion', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)

        # Adding field 'AsignacionCuerpoMaterialMayor.listado_de_material_menor'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'listado_de_material_menor', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)

        # Adding field 'AsignacionCuerpoMaterialMayor.observaciones'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'observaciones', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AsignacionCuerpoMaterialMayor.fecha_de_asignacion'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_asignacion')

        # Deleting field 'AsignacionCuerpoMaterialMayor.acta_de_entrega_de_asignacion'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'acta_de_entrega_de_asignacion')

        # Deleting field 'AsignacionCuerpoMaterialMayor.listado_de_material_menor'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'listado_de_material_menor')

        # Deleting field 'AsignacionCuerpoMaterialMayor.observaciones'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'observaciones')
