...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('interface_asignacionpatentematerialmayor', (
            ...
            ('patente', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('interface', ['AsignacionPatenteMaterialMayor'])

        # Adding field 'MaterialMayor.asignacion_de_patente'
        db.add_column('interface_materialmayor', 'asignacion_de_patente', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['interface.AsignacionPatenteMaterialMayor'], unique=True, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MaterialMayor.asignacion_de_patente'
        db.delete_column('interface_materialmayor', 'asignacion_de_patente_id')
