...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('interface_operacionmantencionpauta', (
            ('operacionmantencion_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['interface.OperacionMantencion'], unique=True, primary_key=True)),
        ...
        # Deleting field 'OperacionMantencion.pauta'
        db.delete_column('interface_operacionmantencion', 'pauta_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'OperacionMantencion.pauta'
        db.add_column('interface_operacionmantencion', 'pauta', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['interface.PautaMantencion']), keep_default=False)
    ...
    models = {
        ...
        'interface.operacionmantencionpauta': {
            'Meta': {'ordering': "['id']", 'object_name': 'OperacionMantencionPauta', '_ormbases': ['interface.OperacionMantencion']},
            'operacionmantencion_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.OperacionMantencion']", 'unique': 'True', 'primary_key': 'True'}),
