...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AsignacionCuerpoMaterialMayor.transferencia_por_escritura_publica'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'transferencia_por_escritura_publica', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AsignacionCuerpoMaterialMayor.fecha_de_escritura'
        db.add_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_escritura', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Changing field 'AsignacionCuerpoMaterialMayor.fecha_de_asignacion'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_asignacion', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AsignacionCuerpoMaterialMayor.transferencia_por_escritura_publica'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'transferencia_por_escritura_publica')

        # Deleting field 'AsignacionCuerpoMaterialMayor.fecha_de_escritura'
        db.delete_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_escritura')

        # Changing field 'AsignacionCuerpoMaterialMayor.fecha_de_asignacion'
        db.alter_column('interface_asignacioncuerpomaterialmayor', 'fecha_de_asignacion', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 10, 11)))
    ...
    models = {
        ...
        'interface.asignacioncuerpomaterialmayor': {
            ...
            'eventohojavidamaterialmayor_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['interface.EventoHojaVidaMaterialMayor']", 'unique': 'True', 'primary_key': 'True'}),
            'fecha_de_asignacion': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
