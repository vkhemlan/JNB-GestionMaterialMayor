...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.webservice_id'
        db.add_column('interface_userprofile', 'webservice_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.webservice_id'
        db.delete_column('interface_userprofile', 'webservice_id')
