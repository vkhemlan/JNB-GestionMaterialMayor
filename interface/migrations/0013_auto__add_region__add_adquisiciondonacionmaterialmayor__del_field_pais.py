...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('interface_adquisiciondonacionmaterialmayor', (
            ('materialmayor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['interface.MaterialMayor'], unique=True, primary_key=True)),
        ...
        # Deleting field 'Pais.name'
        db.delete_column('interface_pais', 'name')

        # Adding field 'Pais.nombre'
        db.add_column('interface_pais', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Pais.name'
        db.add_column('interface_pais', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'Pais.nombre'
        db.delete_column('interface_pais', 'nombre')
