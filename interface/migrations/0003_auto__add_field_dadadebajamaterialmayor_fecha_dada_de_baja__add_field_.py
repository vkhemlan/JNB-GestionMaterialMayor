...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DadaDeBajaMaterialMayor.fecha_dada_de_baja'
        db.add_column('interface_dadadebajamaterialmayor', 'fecha_dada_de_baja', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 19)), keep_default=False)

        # Adding field 'DadaDeBajaMaterialMayor.numero_orden_del_dia'
        db.add_column('interface_dadadebajamaterialmayor', 'numero_orden_del_dia', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'DadaDeBajaMaterialMayor.fecha_orden_del_dia'
        db.add_column('interface_dadadebajamaterialmayor', 'fecha_orden_del_dia', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 1, 19)), keep_default=False)

        # Adding field 'DadaDeBajaMaterialMayor.archivo_orden_del_dia'
        db.add_column('interface_dadadebajamaterialmayor', 'archivo_orden_del_dia', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DadaDeBajaMaterialMayor.fecha_dada_de_baja'
        db.delete_column('interface_dadadebajamaterialmayor', 'fecha_dada_de_baja')

        # Deleting field 'DadaDeBajaMaterialMayor.numero_orden_del_dia'
        db.delete_column('interface_dadadebajamaterialmayor', 'numero_orden_del_dia')

        # Deleting field 'DadaDeBajaMaterialMayor.fecha_orden_del_dia'
        db.delete_column('interface_dadadebajamaterialmayor', 'fecha_orden_del_dia')

        # Deleting field 'DadaDeBajaMaterialMayor.archivo_orden_del_dia'
        db.delete_column('interface_dadadebajamaterialmayor', 'archivo_orden_del_dia')
